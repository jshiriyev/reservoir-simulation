...
class Fluid():
    ...
    def visc(self,value):
        ...
        self._visc = numpy.ravel(value).astype(float)*0.001
    ...
    def rho(self,value):
        ...
        self._rho = numpy.ravel(value).astype(float)*16.0185
    ...
    def comp(self,value):
        ...
        self._comp = numpy.ravel(value).astype(float)/6894.76
    ...
    def fvf(self,value):
        ...
        self._fvf = numpy.ravel(value).astype(float)
    ...
    def satur(self,value):
        ...
        self._satur = numpy.ravel(value).astype(float)
    ...
    def rperm(self,value):
        ...
        self._rperm = numpy.ravel(value).astype(float)
