...
class StonesI():
    ...
    def oil_water(self,value):
        ...
        self._oil_water = BrooksCorey(self.swr,self.sor_ow,self.k0rw_ow,self.k0ro_ow,self.nw,self.no)
    ...
    def gas_oil(self,value):
        ...
        self._gas_oil = BrooksCorey(self.slr_go,self.sgr,self.k0ro_go,self.k0rg_go,self.no,self.ng)
...
if __name__ == "__main__":
    ...
    rp = Stones(swr=0.15,sor_ow=0.15,sor_go=0.05,sgr=0.1,k0rw_ow=0.3,k0ro_ow=0.88,k0ro_go=0.8,k0rg_go=0.3)
